...
public class HealthCenterRestApiController {
    ...
    @PostMapping("/nearest/five")
    public List <NearestHealthCenterDTO> getBestCenterDTOs(@RequestBody LocationDTO location) {
        return healthCenterService.getCloserCenter(location, 5); //rechercher les 5 plus proche centre de sante
    }

    @PostMapping("/nearest/five/amenity")
    public List <NearestHealthCenterDTO> getBestCenterDTOsByAmenity(@RequestBody LocationDTO location, @RequestParam Long amenityId) {
        return healthCenterService.getCloserCenterByAmenity(location, amenityId, 5); //rechercher les 5 plus proche centre de sante selon l'amenity
    }
}
